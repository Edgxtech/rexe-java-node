...
public class ClassloaderTest {
    ...
    public void setUp() throws Exception {
        ...
        when(drfClient1.compute(any(Multihash.class),any(),eq("tech.edgx.dp.chatsvc.DP:retrieve"), argThat(new DpArgsMatcher(Optional.of(new String[]{TEST_USERNAME_A}))), any())).thenReturn(
        ...
        when(drfClient1.compute(any(Multihash.class),any(),eq("tech.edgx.dp.chatsvc.DP:retrieve"), argThat(new DpArgsMatcher(Optional.of(new String[]{TEST_USERNAME_B}))), any())).thenReturn(
